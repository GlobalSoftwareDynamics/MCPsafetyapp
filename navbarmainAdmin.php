    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="dropdown">
                    <a href="generaciondereportes.php" class="dropdown-toggle" role="button" aria-haspopup="true" aria-expanded="false">ESTADÍSTICAS DE SEGURIDAD<span class="caret"></span></a>
                </li>
                <li class="dropdown">
