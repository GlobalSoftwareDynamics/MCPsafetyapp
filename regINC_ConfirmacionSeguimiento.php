...
if(isset($_SESSION['login'])&&(($_SESSION['usertype']=='1'))){
    ...
    <section class="container">
        ...
        if(mkdir("Fotografias/Incidentes/{$_POST['idINC']}/Seguimiento/{$_POST['idAC']}",0777,true)){
            //echo "Directorio creado.";
        }else{
            //echo "Directorio existente.";
        }
        $target_dir = "Fotografias/Incidentes/{$_POST['idINC']}/Seguimiento/{$_POST['idAC']}/";
        ...
        if ($uploadOk == 0) {
            ...
            $i = 0;
            $dir = "Fotografias/Incidentes/{$_POST['idINC']}/Seguimiento/{$_POST['idAC']}/";
            ...
            $newfilename = $_POST['idINC']."-".$_POST['idAC']."-{$i}.jpg";
            ...
            $resizedFile = $target_dir.$_POST['idINC']."-".$_POST['idAC']."-{$i}.jpg";
    ...
    <section class="container">
        <form method="post" action="#" class="form-horizontal jumbotron col-xs-12 col-md-6 col-md-offset-3">
            <div class="form-group col-xs-12 col-md-12">
                ...
                <input class="btn btn-success col-xs-12 col-md-12" type="submit" formaction="regINC_Seguimiento.php" value="Añadir otra fotografía">
                <input class="btn btn-default col-xs-12 col-md-12" type="submit" formaction="detalleIncidente.php" value="Siguiente" name="siguienteSeguimiento">
            </div>
        </form>
    </section>
