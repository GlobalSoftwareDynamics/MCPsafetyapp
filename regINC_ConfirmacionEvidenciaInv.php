...
if(isset($_SESSION['login'])&&(($_SESSION['usertype']=='1'))){
    ...
    <section class="container">
        ...
        if(mkdir("Fotografias/Incidentes/{$_POST['idINC']}/Investigación/",0777,true)){
            //echo "Directorio creado.";
        }else{
            //echo "Directorio existente.";
        }
        $target_dir = "Fotografias/Incidentes/{$_POST['idINC']}/Investigación/";
        ...
        if ($uploadOk == 0) {
            ...
            $newfilename = $_POST['idINC']."Inv-{$i}.jpg";
            ...
            if($uploadOk == 1){
		        ...
		        echo "<div class='container'><span class='alert alert-danger col-md-8 col-md-offset-2'>Reduzca la resolución de la imágen.</span></div><br>";
	        }
            ...
            $resizedFile = $target_dir.$_POST['idINC']."Inv-{$i}.jpg";
    ...
    <section class="container">
        <form method="post" action="#" class="form-horizontal jumbotron col-xs-12 col-md-6 col-md-offset-3">
            <div class="form-group col-xs-12 col-md-12">
                ...
                <input class="btn btn-success col-xs-12 col-md-12" type="submit" formaction="regINC_FotosInvestigacion.php" value="Añadir otra fotografía">
                <input class="btn btn-default col-xs-12 col-md-12" type="submit" formaction="detalleIncidente.php" value="Siguiente" name="siguienteInvestigacion">
            </div>
        </form>
    </section>
