...
if(isset($_SESSION['login'])&&($_SESSION['usertype']=='1')){
    ...
    while ($fila=mysqli_fetch_array($result)){
        ...
        for($j=0;$j<$i;$j++){
            $html .='<tr class="trborder"><td>';
            $html .='<img src="Fotografias/Incidentes/'.$_POST['idINC'].'/Investigación/'.$_POST['idINC'].'Inv-'.$j.'.jpg" alt="Investigación'.$j.'" style="width:350;height:280;margin-bottom:20px;margin-left: 10px;margin-right: 65px;">';
            $html .='</td></tr>';
        }
        $html .= '
                </tbody>
        ...
        $html .= '
            ...
            <table class="tabla">
                <thead>
                <tr class="trborder">
                    <th>Evidencia de Cumplimiento de Acciones Correctivas</th>
                </tr>
                </thead>
                <tbody>';
        $aux=0;
        ...
        while($row = mysqli_fetch_array($query)){
            ...
            while ($fila2=mysqli_fetch_array($result2)){
                ...
                $html .='<tr class="trborder"><td class="text-justify">';
                $html .='<p><b>'.$aux.'.</b> '.$fila2['descripcion'].'</p><br>';
                for($j=0;$j<$i;$j++){
                    $html .='<img src="Fotografias/Incidentes/'.$_POST['idINC'].'/Seguimiento/'.$row['idAccionesCorrectivas'].'/'.$_POST['idINC'].'-'.$row['idAccionesCorrectivas'].'-'.$j.'.jpg" alt="SeguimientoAC'.$j.'" style="width:304px;height:228px;margin-bottom:20px;margin-left: 10px;margin-right: 65px;">';
                }
                $html .='</td></tr>';
            }
        }
        $html .='
            ...
            <tbody>
                <tr class="trborder">
                    <th>Responsable del Cierre del Reporte:</th>';
