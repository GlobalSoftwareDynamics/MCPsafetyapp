    ...
    <section class="container">
        <div>
            <form method="post" class="form-horizontal jumbotron col-xs-12 col-md-6 col-md-offset-3">
                <h4 class="text-center">¿Desea registrar una posible Mejora de Seguridad?</h4>
                <div class="form-group col-xs-12 col-md-12">
                    <input type="hidden" name="idOCUR" value="<?php echo $_POST['idOCUR'];?>" readonly>
                    <div class="col-xs-12 col-md-6">
                        <input type="submit" class="btn btn-success col-xs-12 col-md-10 col-md-offset-1" formaction="regOC_MejorasSeguridad.php" name="siguiente" value="Sí">
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <input type="submit" class="btn btn-primary col-xs-12 col-md-10 col-md-offset-1" formaction="regOC_RevisionFinal.php" name="siguiente" value="No">
                    </div>
                </div>
            </form>
        </div>
