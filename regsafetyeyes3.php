        ...
        <form method="post" class="form-horizontal jumbotron col-xs-12 col-sm-6 col-sm-offset-3">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-6">
                    <input type="submit" class="btn btn-success col-xs-12 col-sm-10 col-sm-offset-1" formaction="regsafetyeyes3.php?user=<?php echo $_GET['user'];?>" name="agregar" value="Agregar">
                </div>
                <div class="col-xs-12 col-sm-6">
                    <input type="submit" class="btn btn-primary col-xs-12 col-sm-10 col-sm-offset-1" formaction="regsafetyeyes4.php?user=<?php echo $_GET['user'];?>" name="siguiente" value="Siguiente">
                </div>
            </div>
        </form>
    </div>
