...
<section class="container">
    <form action="aprobarOCUR.php" method="post" class="form-horizontal jumbotron col-md-12 col-xs-12">
            ...
            if(isset($_POST['filtrar'])&&isset($_POST['columna'])&&isset($_POST['busqueda'])){
                if ($_POST['columna']==="reportante"){
                    ...
                    while ($fila0=mysqli_fetch_array($result0)){
                        ...
                        while ($fila=mysqli_fetch_array($result)){
                            $result1=mysqli_query($link,"SELECT * FROM Ocurrencias WHERE idOcurrencias ='".$fila['idOcurrencias']."' AND estado='Pendiente' AND idClase != '8' ORDER BY fecha DESC");
                            while ($fila1=mysqli_fetch_array($result1)){
                                echo "
                                    <td>".$fila1['fecha']."</td>
                                ...
                                echo "
                                    <td>
                                        <form method='post'>
                                            ...
                                            <input type='submit' class='btn-link' value='Detalle' formaction='detalleOcurrencia.php'>
                                        </form>
                                    </td>
                                ";
                                echo "
                    ...
                    while ($fila0=mysqli_fetch_array($result0)){
                        ...
                        while ($fila1=mysqli_fetch_array($result1)){
                            $result2=mysqli_query($link,"SELECT * FROM Ocurrencias WHERE idUbicacion ='".$fila1['idUbicacion']."' AND estado='Pendiente' AND idClase != '8' ORDER BY fecha DESC");
                            while ($fila2=mysqli_fetch_array($result2)){
                                echo "
                                    <td>".$fila2['fecha']."</td>
                    ...
                    while ($fila0=mysqli_fetch_array($result0)){
                        $result1=mysqli_query($link,"SELECT * FROM Ocurrencias WHERE idUbicacion ='".$fila0['idUbicacion']."'  AND estado='Pendiente' AND idClase != '8' ORDER BY fecha DESC");
                        while ($fila1=mysqli_fetch_array($result1)){
                            echo "
                                <td>".$fila1['fecha']."</td>
                                <td>".$fila1['idOcurrencias']."</td>
                    ...
                    echo "
                        <tr>
                    ";
                    $result0=mysqli_query($link,"SELECT * FROM Ocurrencias WHERE ".$_POST['columna']." LIKE '%".$_POST['busqueda']."%'  AND estado='Pendiente' AND idClase != '8' ORDER BY fecha DESC");
                    while ($fila0=mysqli_fetch_array($result0)){
                        echo "
                            <td>".$fila0['fecha']."</td>
                ...
                echo "
                        <tr>
                    ";
                $result0=mysqli_query($link,"SELECT * FROM Ocurrencias WHERE estado='Pendiente' AND idClase != '8' ORDER BY fecha DESC");
                while ($fila0=mysqli_fetch_array($result0)){
                    echo "
                            <td>".$fila0['fecha']."</td>
                            <td>".$fila0['idOcurrencias']."</td>
