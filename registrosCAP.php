...
<section class="container">
    <form action="registrosCAP.php" method="post" class="form-horizontal jumbotron col-md-12 col-xs-12">
        ...
        <table class="table table-hover text-center">
            ...
            if(isset($_POST['filtrar'])&&isset($_POST['columna'])&&isset($_POST['busqueda'])){
                if ($_POST['columna']==="reportante"){
                    ...
                    while ($fila0=mysqli_fetch_array($result0)){
                        ...
                        while ($fila=mysqli_fetch_array($result)){
                            $result1=mysqli_query($link,"SELECT * FROM CAP WHERE estado='Aprobado' AND idCAP = '".$fila['idCAP']."' ORDER BY fecha ASC");
                    ...
                    while ($fila0=mysqli_fetch_array($result0)){
                        $result1=mysqli_query($link,"SELECT * FROM CAP WHERE idComportamiento ='".$fila0['idComportamiento']."'  AND estado='Aprobado' ORDER BY fecha ASC");
                        while ($fila1=mysqli_fetch_array($result1)){
                            echo "
                                <td>".$fila1['fecha']."</td>
                                <td>".$fila1['idCAP']."</td>
                    ...
                    echo "
                        <tr>
                    ";
                    $result0=mysqli_query($link,"SELECT * FROM CAP WHERE ".$_POST['columna']." LIKE '%".$_POST['busqueda']."%'  AND estado='Aprobado' ORDER BY fecha ASC");
                    while ($fila0=mysqli_fetch_array($result0)){
                        echo "
                            <td>".$fila0['fecha']."</td>
                            <td>".$fila0['idCAP']."</td>
                ...
                echo "
                        <tr>
                    ";
                $result0=mysqli_query($link,"SELECT * FROM CAP WHERE estado='Aprobado' ORDER BY fecha ASC");
                while ($fila0=mysqli_fetch_array($result0)){
                    echo "
                            <td>".$fila0['fecha']."</td>
                            <td>".$fila0['idCAP']."</td>
