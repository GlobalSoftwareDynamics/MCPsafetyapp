...
if(isset($_SESSION['login'])&&($_SESSION['usertype']=='1')){
    ...
    <section class="container">
        ...
        <form method="post" action="regINC_DatosGenerales.php" class="form-horizontal col-sm-12 col-xs-12">
            <div class="col-sm-6 col-sm-offset-3 col-xs-12">
                <input type="submit" value="Crear Reporte" name="crearcero" class="btn btn-success col-sm-8 col-sm-offset-2 col-xs-12">
            </div>
        </form>
    </section>
    <hr>
    <section class="container">
        ...
        while ($fila=mysqli_fetch_array($result)) {
            ?>
            <form method="post" class="col-xs-12 col-sm-6 form-horizontal jumbotron">
                <div class="form-group">
                    <label for="idac" class="col-xs-12 col-sm-4">Código:</label>
                    <input id="idac" class="col-xs-12 form-control col-sm-8" name="idOCUR" value="<?php echo $fila['idOcurrencias']?>" readonly>
                </div>
                <div class="form-group">
                    <label for="desc">Descripción:</label>
                    <textarea name="descripcion" class="form-control col-xs-12 col-sm-12" rows="5" id="desc"><?php echo $fila['descripcion']?></textarea>
                </div>
                <div class="form-group">
                    <div class="col-xs-12 col-sm-4">
                        <input type="submit" formaction="regINC_DatosGenerales.php" name="crearInc" value="Crear Reporte" class="btn btn-success col-xs-12 col-sm-12">
                    </div>
                    <div class="col-xs-12 col-sm-4">
                        <input type="submit" formaction="crearRepInc.php" name="cambclase" value="Volver AS" class="btn btn-primary col-xs-12 col-sm-12">
                    </div>
                    <div class="col-xs-12 col-sm-4">
                        <input type="submit" formaction="crearRepInc.php" name="descartar" value="Descartar" class="btn btn-default col-xs-12 col-sm-12">
                    </div>
                </div>
            </form>
            <?php
