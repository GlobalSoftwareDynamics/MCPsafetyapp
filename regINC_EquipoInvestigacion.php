    ...
    <section class="container">
        <div>
            <form method="post" class="form-horizontal jumbotron col-xs-12 col-md-offset-3 col-md-6">
                <div class="col-xs-12">
                    <h4 class="text-left">Equipo de Investigación</h4>
                </div>
                ...
                <div class="form-group col-xs-12 col-md-12">
                    <div class="col-xs-12">
                        <label for="part">Participó como:</label>
                    </div>
                    <div class="col-xs-12">
                        <select id="part" name="tipodeparticipante" class="form-control col-xs-12">
                            <option>Seleccionar</option>
                            <option value="8">Líder de la Investigación</option>
                            <option value="9">Miembro del Equipo</option>
                        </select>
                    </div>
                </div>
                <hr>
                <div class="form-group col-xs-12 col-md-12">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <input type="submit" class="btn btn-success col-xs-12 col-md-10 col-md-offset-1" formaction="regINC_EquipoInvestigacion.php" name="agregar" value="Guardar">
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <input type="submit" class="btn btn-primary col-xs-12 col-md-10 col-md-offset-1" formaction="regINC_Causas.php" name="siguiente" value="Siguiente">
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <input type="submit" class="btn btn-default col-xs-12 col-md-10 col-md-offset-1" formaction="verRegINC_EquipoInvestigacion.php" name="revisar" value="Revisar Datos">
                    </div>
                    <div class="col-xs-12 col-md-6">
