...
$datos1=NumIncidentesxPlanta($_POST['anio'],$_POST['planta'],$link);
$datos2=NumTotalUbicacionIncAño($_POST['anio'],$_POST['planta'],$link);
$datos3=NumConsActIncxAnioxPlanta($_POST['anio'],$_POST['planta'],$link);
$labels3=multilabel('Consecuencia',$link);
$datos4=NumConsPotIncxAnioxPlanta($_POST['anio'],$_POST['planta'],$link);
$labels4=multilabel('Consecuencia',$link);
$datos5=NumLesionIncxAnioxPlanta($_POST['anio'],$_POST['planta'],$link);
$labels5=multilabeltipolesion($link);
$datos6=NumIntEnergiaIncxPlantaAnio($_POST['anio'],$_POST['planta'],$link);
$datos7=NumRepeticionIncxPlantaAnio($_POST['anio'],$_POST['planta'],$link);
$datos8=NumTotalParteCuerpoIncPlantaUnicaAnio($_POST['anio'],$_POST['planta'],$link);
$labels8=multilabel('ParteCuerpo',$link);
$datos9=NumAccionesCorrectivasIncxAnioxPlanta($_POST['anio'],$_POST['planta'],$link);
...
// Instantiate and draw our chart, passing in some options.
    ...
    function drawChart2() {
        ...
        var options = {
            title: "Número de Incidentes Reportados por Ubicación",
            titleTextStyle: {fontSize: 18, bold: true},
            width: '100%',
            height: 300,
            legend: { position: 'top'}
...
<section class="container">
    ...
    <table class="table table-bordered text-center">
        ...
        while ($fila0=mysqli_fetch_array($result0)){
            $result1=mysqli_query($link,"SELECT * FROM ACINC WHERE idAccionesCorrectivas ='".$fila0['idAccionesCorrectivas']."' AND idIncidentes IN (SELECT idIncidentes FROM Incidentes WHERE idIncidentes LIKE 'INC".$año[1]."%' AND idUbicacion IN (SELECT idUbicacion FROM Ubicacion WHERE idPlanta = '{$_POST['planta']}'))");
