...
?>
    ...
    if (isset($_POST['agregar'])){
        ...
        $agregar="INSERT INTO MejorasSeguridad(idMejoras, dni, idEstado, fecharegistro ,descripcion, fuente, fechaactualizacion) VALUES ('".$_POST['idMS']."','".$dni."',5,'".$fecharegistro."','".$_POST['descripcion']."','OC',null)";
        /*echo $agregar;*/
        $query=mysqli_query($link,$agregar);
        $agregar="INSERT INTO MEOCUR(idMejoras, idOcurrencias) VALUES (
    '".$_POST['idMS']."','".$_POST['idOCUR']."'
    )";
        /*echo $agregar;*/
        $query=mysqli_query($link,$agregar);
        echo "
            ...
            <form method="post" class="form-horizontal jumbotron col-xs-12 col-md-6 col-md-offset-3">
                ...
                <div class="form-group col-xs-12 col-md-12">
                    ...
                    <div class="col-xs-12 col-md-6">
                        <input type="submit" class="btn btn-success col-xs-12 col-md-10 col-md-offset-1" formaction="regOC_MejorasSeguridad.php" name="agregar" value="Guardar">
                    </div>
                    <?php
                    ...
                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                        <input type="submit" class="btn btn-default col-xs-12 col-md-10 col-md-offset-1" formaction="verRegOC_MejorasSeguridad.php" name="revisar" value="Revisar Datos Ingresados">
                    </div>
                </div>
            </form>
        </div>
