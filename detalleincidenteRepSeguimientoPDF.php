...
if(isset($_SESSION['login'])&&($_SESSION['usertype']=='1')){
    ...
    while ($fila=mysqli_fetch_array($result)){
        ...
        for($j=0;$j<$i;$j++){
            $html .='<tr class="trborder"><td>';
            $html .='<img src="Fotografias/Incidentes/'.$_POST['idINC'].'/Investigación/'.$_POST['idINC'].'Inv-'.$j.'.jpg" alt="Investigación'.$j.'" style="width:350px;height:280px;margin-bottom:20px;margin-left: 10px;margin-right: 65px;">';
            $html .='</td></tr>';
        }
        $html .= '
                </tbody>
