...
$datos=NumOcurrenciasxPersonaReportanteAño($_POST['dni'],$_POST['anio'],$link);
$datos1=NumOcurrenciasxPersonaReportadoAño($_POST['dni'],$_POST['anio'],$link);
$datos2=NumAccionesCorrectivasxPersonaOCAño($_POST['dni'],$_POST['anio'],$link);
