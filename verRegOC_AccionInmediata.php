...
if(isset($_SESSION['login'])&&(($_SESSION['usertype']=='1')||($_SESSION['usertype']=='2')||($_SESSION['usertype']=='5'))){
    ...
    if(isset($_POST['delete'])){
        $delete = mysqli_query($link, "DELETE FROM AIOCUR WHERE idAccionesInmediatas = '".$_POST['idAI']."' AND idOcurrencias = '".$_POST['idOCUR']."'");
    ...
    <section class="container">
        <div>
            <table class="table">
                ...
                <tbody>
                <?php
                $query = mysqli_query($link, "SELECT * FROM AIOCUR WHERE idOcurrencias = '".$_POST['idOCUR']."'");
                while($row = mysqli_fetch_array($query)){
                    ...
                    echo "<td class='text-center'>
											<form method='post' action='verRegOC_AccionInmediata.php'>
            ...
            <form method="post">
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-md-6 col-md-offset-3">
                        <input type="submit" class="btn btn-default col-xs-12 col-md-10 col-md-offset-1" formaction="regOC_AccionInmediata.php" name="back" value="Regresar">
                    </div>
                </div>
            </form>
        </div>
